...
public Employee(){};
    ...
    public Employee(String Name,  String NoAccount, String IdRetiro, String Ndoc, 
            String IdEmployee, int Seniority) {
    ...
    public String toString() {
        ...
        sb.append("\nIdentificacion de usuario: ").append(super.getNoAccount());
